...
public class IDs {
	...
	public static class SparkMAXs {

		public static final SparkMaxDeviceID FUNNEL = new SparkMaxDeviceID(52, SparkLowLevel.MotorType.kBrushless);

		public static final SparkMaxDeviceID INTAKE = new SparkMaxDeviceID(3, SparkLowLevel.MotorType.kBrushless);

		public static final SparkMaxDeviceID ELBOW = new SparkMaxDeviceID(5, SparkLowLevel.MotorType.kBrushless);

		public static final SparkMaxDeviceID ROLLER = new SparkMaxDeviceID(22, SparkLowLevel.MotorType.kBrushless);

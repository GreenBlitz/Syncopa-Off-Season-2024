...
public class StatesMotionPlanner {
	...
	public Command setState(RobotState state) {
		return switch (state) {
<<<<<<< HEAD
			case INTAKE, SOURCE_INTAKE, ARM_INTAKE, SPEAKER, TRANSFER_SHOOTER_TO_ARM, TRANSFER_ARM_TO_SHOOTER ->
			...
			case INTAKE_OUTTAKE, SHOOTER_OUTTAKE, AMP, ARM_OUTTAKE, PRE_AMP, PRE_SPEAKER, IDLE -> superstructure.setState(state);
=======

...
//	}
	...
	public Command setState(RobotState state) {
		return robotCommandGenerator.makeRobotCommand(switch (state) {
			case IDLE -> new RunCommand(() -> {});
			case INTAKE -> new RunCommand(() -> {});
			case INTAKE_WITH_FLYWHEEL -> new RunCommand(() -> {});
			case ARM_INTAKE -> new RunCommand(() -> {});
			case PRE_SPEAKER -> new RunCommand(() -> {});
			case SPEAKER -> new RunCommand(() -> {});
			case PRE_AMP -> new RunCommand(() -> {});
			case AMP -> new RunCommand(() -> {});
			case ARM_UP -> new RunCommand(() -> {});
			case TRANSFER_SHOOTER_TO_ARM -> new RunCommand(() -> {});
			case TRANSFER_ARM_TO_SHOOTER -> new RunCommand(() -> {});
			case INTAKE_OUTTAKE -> new RunCommand(() -> {});
			case ARM_OUTTAKE -> new RunCommand(() -> {});
			case PASSING -> new RunCommand(() -> {});
		}, state);
	}

...
public class Tolerances {
	...
	public static final Rotation2d ELBOW_POSITION_TOLERANCE = Rotation2d.fromDegrees(2);
	public static final Rotation2d PIVOT_POSITION_TOLERANCE = Rotation2d.fromDegrees(2);
	public static final Rotation2d FLYWHEEL_VELOCITY_PER_SECOND_TOLERANCE = Rotation2d.fromRotations(2);
